...
import { Form, useLoaderData, useParams, useNavigation } from "@remix-run/react"
...
// action -> used to manipulate data (add, update, remove)
...
export default function Comments() {
  ...
  return (
    <div className="rounded-lg border p-3">
      ...
      <div>
        {/* declarative way to perform data mutations; creating, updating and deleting data.  */}
        {/* automatic mutation and revalidation.  */}
        <Form method="POST">
          <textarea
            name="comment"
